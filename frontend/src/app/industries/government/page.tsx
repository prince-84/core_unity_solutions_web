...
export default function GovernmentPage() {
  ...
  const accordionItems = [
    { 
      title: "We Build Government Solutions That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Secure Platform Development</strong>
            CoreUnity builds government platforms designed around security and reliability.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Accessible Design</strong>
            We build websites and portals accessible to all users, meeting public sector standards.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Scalable Infrastructure</strong>
            Our solutions are built to scale as public sector needs grow.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of your digital project</li>
          <li>We give attention to the smallest security and accessibility details</li>
          <li>We help public sector organizations serve citizens better</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best Digital Partner for the Government in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Public Sector Expertise</strong>
            We understand the unique standards government projects require.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've delivered secure, accessible platforms for public sector clients.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Ongoing Support</strong>
            We remain available for updates, security, and maintenance long-term.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds Digital Solutions for the Public Sector", 
      content: (
        <div className="space-y-4">
          <p>
            Government digital platforms carry a higher bar. Security, accessibility, and reliability aren't optional. As a trusted technology partner, we build platforms that meet these standards.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build Government Features That Meet Front-Line Technology</strong>
            Our mission is to help public sector organizations serve citizens more efficiently — from accessible design to secure, reliable platforms.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our Government Digital Services Are Built for Trust</strong>
            We work closely with public sector clients to build platforms that are secure, accessible, and easy to navigate for every citizen.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Government Features That Drive Results</strong>
            With secure architecture, accessible design, and reliable performance, our solutions help public sector organizations serve the public more effectively.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your Public Sector Technology Partner</h1>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.15] text-white mb-6 tracking-tight">
              Digital Solutions Built for the Public Sector
            </h2>
            
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We help government entities and public sector organizations build secure, accessible websites and platforms, designed to serve the public efficiently and meet public sector standards.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Secure, compliant digital platforms</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Accessible design for all users</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Reliable, scalable public sector solutions</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Government Sector Solutions" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Government Digital<br />Agency<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight">
                Looking for a technology partner for your next public sector project?
              </h2>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              Government Digital Strategies Built for<br className="hidden md:block" />
              Real Trust
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              At CoreUnity Solutions, we blend security, accessibility, and robust architecture 
              to build digital platforms that the public sector and citizens can rely on.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Government Portals Built</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">100%</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Accessibility Compliant</p>
            </div>
            {/* Card 3 */}
            ...
            <div className="bg-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-xl">
              ...
              <p className="text-[#1f1f1f] text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Security & Maintenance</p>
            </div>
          </div>
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Discovery & Compliance</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Understanding project goals, technical requirements, and public sector compliance standards.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Secure Architecture</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Designing robust, secure, and scalable technical foundations to handle high public traffic.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Accessible Development</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Building intuitive user interfaces ensuring accessibility for all citizens across all devices.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Deployment & Support</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Launching the platform securely and providing ongoing, long-term maintenance and updates.</p>
            </div>
          </div>
        </div>
      </section>
