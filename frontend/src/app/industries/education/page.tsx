...
export default function EducationPage() {
  ...
  const accordionItems = [
    { 
      title: "We Build Education Solutions That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Enrollment-Focused Websites</strong>
            CoreUnity builds websites designed to guide prospective students toward enrollment.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Education SEO</strong>
            We build SEO strategies that help institutions rank for relevant searches.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Community-Building Social Media</strong>
            Our social strategies help build engaged school and alumni communities.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>We give attention to the smallest details that build trust with parents</li>
          <li>We help education brands grow enrollment and reputation</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best Digital Partner for Education in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Education-Specific Expertise</strong>
            We understand what matters to students and parents researching schools.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've helped education brands grow inquiries and enrollment.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Full-Service Support</strong>
            From websites to social media, we manage the full recruitment journey.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds Digital Solutions for Better Student Enrollment", 
      content: (
        <div className="space-y-4">
          <p>
            Choosing a school or course starts with a search. Your digital presence needs to make the right impression. As a trusted education marketing partner, we help institutions attract the right students.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build Education Features That Meet Front-Line Technology</strong>
            Our mission is to help education brands grow their reach — from enrollment-focused websites to SEO and social media strategy.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our Education Digital Services Are Built for Enrollment Growth</strong>
            We work closely with clients to build websites and campaigns that attract and convert prospective students and parents.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Education Features That Drive Results</strong>
            With enrollment-focused design, targeted SEO, and community-building social media, our solutions help grow student inquiries and enrollment.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your Education Marketing Partner</h1>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.15] text-white mb-6 tracking-tight">
              Digital Solutions Built to Grow Enrollment
            </h2>
            
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We help schools, universities, and training institutes build engaging websites, SEO, and marketing campaigns designed to attract prospective students and parents.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Enrollment-focused website design</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Education-specific SEO strategy</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Social media strategies that build community</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Education Industry" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Education Digital<br />Agency<br />in Dubai
            </h2>
          </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              Education Digital Strategies Built for<br className="hidden md:block" />
              Enrollment Growth
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              At CoreUnity Solutions, we combine appealing web design, smart SEO, 
              and engaging social strategies to build your institution's reputation and student intake.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Education Sites Built</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">85%</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Enrollment Growth Boost</p>
            </div>
            {/* Card 3 */}
            ...
            <div className="bg-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-xl">
              ...
              <p className="text-[#1f1f1f] text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Student Journey Management</p>
            </div>
          </div>
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Understanding your academic offerings, target demographics, and student enrollment goals.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Enrollment-Focused Design</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Building intuitive websites that guide prospective students clearly towards program information and applications.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">SEO & Digital Marketing</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Launching targeted SEO and paid campaigns to ensure your institution ranks highly for course searches.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Community & Social Media</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Developing engaging social strategies to showcase campus culture and build active student communities.</p>
            </div>
          </div>
        </div>
      </section>
