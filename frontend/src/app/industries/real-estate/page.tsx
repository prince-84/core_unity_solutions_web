...
export default function RealEstatePage() {
  ...
  const accordionItems = [
    { 
      title: "We Build Real Estate Solutions That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Listing-Focused Websites</strong>
            CoreUnity builds websites designed to showcase properties and convert visitors into leads.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Virtual Property Tours</strong>
            We build immersive VR tours that let buyers explore properties remotely.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Lead Generation Campaigns</strong>
            Our PPC and SEO strategies attract qualified buyers and investors.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>We give attention to the smallest details of your listings</li>
          <li>We help real estate brands close more deals, faster</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best Digital Partner for Real Estate in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Industry-Specific Expertise</strong>
            We understand what buyers and investors respond to in Dubai's property market.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've helped real estate brands generate qualified, ready-to-convert leads.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Full-Service Support</strong>
            From websites to PPC, we manage the full digital journey.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds Digital Solutions for a Better Property Journey", 
      content: (
        <div className="space-y-4">
          <p>
            In Dubai's fast-moving property market, visibility and speed matter. As a trusted real estate digital marketing partner, we help brokerages stand out with strong websites and targeted campaigns.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build Real Estate Features That Meet Front-Line Technology</strong>
            Our mission is to help real estate brands sell faster — from listing pages to virtual tours to AI-powered lead qualification.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our Real Estate Digital Services Are Built for Faster Deals</strong>
            We work closely with clients to build lead generation strategies tailored to property buyers and investors, tracking performance to keep improving results.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Real Estate Features That Drive Results</strong>
            With immersive tours, targeted campaigns, and conversion-focused websites, our solutions help real estate brands close more deals.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your Real Estate Digital Partner</h1>
            </div>
            ...
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We help real estate brands and brokerages stand out with high-performing websites, virtual property tours, targeted PPC campaigns, and lead generation strategies built for Dubai's property market.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> High-converting listing websites</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Virtual tours and immersive property showcases</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Targeted lead generation campaigns</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Real Estate Industry" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Real Estate Digital<br />Agency<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              ...
              <p className="text-red-100 text-[17px] font-light">
                Talk to our real estate marketing team.
              </p>
            </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              Real Estate Digital Strategies Built for<br className="hidden md:block" />
              Real Impact
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              At CoreUnity Solutions, we blend property market expertise, engaging web design, 
              and precise targeting to build campaigns that deliver measurable ROI for brokerages.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Real Estate Sites Built</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">75%</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Avg Lead Quality Boost</p>
            </div>
            {/* Card 3 */}
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Understanding your target market, property portfolio, and goals to build a winning digital strategy.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Website & Virtual Tours</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Designing high-converting property listings and immersive 3D virtual tours to engage buyers.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Lead Generation Setup</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Launching precision-targeted PPC and SEO campaigns to capture qualified real estate investor leads.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Analytics & Scaling</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Monitoring campaign performance, optimizing lead quality, and scaling strategies for faster deals.</p>
            </div>
          </div>
        </div>
      </section>
