  ...
  const accordionItems = [
      ...
      content: (
        <div className="space-y-4">
          <div>
            ...
            CoreUnity builds AI models tailored to your specific business challenges — not off-the-shelf tools.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Seamless Integration</strong>
            We integrate AI solutions cleanly into your existing systems and workflows.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Scalable Architecture</strong>
            Our AI solutions are built to scale as your data and business needs grow.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>We give attention to the details that make AI actually useful</li>
    ...
    { 
      ...
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Practical, Business-First Approach</strong>
          ...
          <div>
            ...
            We've delivered AI solutions across multiple industries, built to perform.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Ongoing Support</strong>
            We stay by your side post-deployment, refining models as your data grows.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds AI for Smarter, Faster Business Growth", 
      content: (
        <div className="space-y-4">
          <p>
            Artificial intelligence isn't just a buzzword for us. It's a practical tool for solving real business problems. As a leading AI development company in Dubai, we design solutions with strong technical performance and measurable business value.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build AI Features That Meet Front-Line Technology</strong>
            Our mission is to help businesses automate smarter and decide faster — from predictive analytics to intelligent automation, integrated cleanly into your existing systems.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our AI Development Services Are Built for Long-Term Value</strong>
            We work closely with clients to identify where AI creates the most impact, then build, test, and refine models to keep delivering results as your data grows.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">AI Features That Drive Results</strong>
            With automation, predictive insights, and intelligent integrations, our AI solutions help businesses save time, cut costs, and make better decisions.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your AI Solutions Partner</h1>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.15] text-white mb-6 tracking-tight">
              AI Solutions Built for Smarter, Faster Business Growth
            </h2>
            
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We build practical AI solutions that automate processes, unlock insights, and drive smarter decisions. From predictive analytics to intelligent automation, every solution is tailored to your business.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              ...
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Process automation that saves real time</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Insights that drive smarter decisions</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Artificial Intelligence Solutions" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Artificial<br />Intelligence Agency<br />in Dubai
            </h2>
          </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              AI Built for<br className="hidden md:block" />
              Real Impact
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              ...
              and business strategy to build AI that delivers measurable ROI.
            </p>
          </div>
