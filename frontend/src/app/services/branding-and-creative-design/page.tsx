    ...
    { 
      ...
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Brand Strategy</strong>
            CoreUnity defines your brand's values, voice, and positioning before design begins.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Visual Identity Design</strong>
            We design logos, color systems, and typography that reflect your brand.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Brand Guidelines</strong>
            Our teams deliver complete guidelines to keep your brand consistent everywhere.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of the branding process</li>
          <li>We give attention to the smallest visual details</li>
          <li>We help brands grow into something people remember</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best Branding Agency in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Strategic Design Process</strong>
            We build brand identity from strategy first, not visuals alone.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've built brand identities that stand out across competitive markets.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Full Brand Toolkits</strong>
            We deliver everything you need to apply your brand consistently.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds Brands That Make You Impossible to Ignore", 
      content: (
        <div className="space-y-4">
          <p>
            Your brand is more than a logo. It's how people feel about your business. As a leading branding agency in Dubai, we build complete brand identities with strong strategic foundations.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build Branding Features That Meet Front-Line Technology</strong>
            Our mission is to help businesses stand out with distinctive identity — from strategy and positioning to full visual design systems.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our Branding Services Are Built for Lasting Recognition</strong>
            We work closely with clients to understand their values and audience, then translate them into a visual identity that stays consistent everywhere.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Branding Features That Drive Results</strong>
            With strategic positioning, distinctive visuals, and consistent guidelines, our branding work helps businesses build recognition and trust.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your Brand Identity Partner</h1>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.15] text-white mb-6 tracking-tight">
              Branding That Makes You Impossible to Ignore
            </h2>
            
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We build complete brand identities, from strategy and positioning to logo design, color systems, and brand guidelines. These are designed to make your business impossible to ignore.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Strategic brand positioning</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Distinctive visual identity systems</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Consistent design across every touchpoint</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Branding & Creative Design" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Branding<br />Agency<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              ...
              <p className="text-red-100 text-[17px] font-light">
                Let's build a brand identity that captures attention and builds trust.
              </p>
            </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              Branding Strategies Built for<br className="hidden md:block" />
              Real Impact
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              At CoreUnity Solutions, we blend strategic positioning, distinctive design, 
              and comprehensive guidelines to build brand identities that leave a lasting impression.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Brand Identities Built</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">85%</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Avg Recognition Boost</p>
            </div>
            {/* Card 3 */}
            ...
            <div className="bg-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-xl">
              ...
              <p className="text-[#1f1f1f] text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Strategic Positioning</p>
            </div>
          </div>
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Understanding your vision, defining your brand values, and establishing strategic positioning.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Concept Development</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Exploring visual concepts, brand voice, and initial design directions for your identity.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Identity Design</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Finalizing your logo, color palette, typography, and visual assets across all touchpoints.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Guidelines & Handoff</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Delivering comprehensive brand guidelines to ensure consistency in future applications.</p>
            </div>
          </div>
        </div>
      </section>
