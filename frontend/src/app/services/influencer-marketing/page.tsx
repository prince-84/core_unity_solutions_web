...
export default function InfluencerMarketingPage() {
  ...
  const accordionItems = [
    { 
      title: "We Build Influencer Campaigns That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Influencer Discovery</strong>
            CoreUnity identifies influencers whose audience genuinely matches your target customers.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Campaign Management</strong>
            We manage outreach, briefs, and content approval from start to finish.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Performance Tracking</strong>
            Our team tracks reach, engagement, and conversions across every partnership.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of influencer partnerships</li>
          <li>We give attention to the smallest brand-alignment details</li>
          <li>We help brands grow through authentic voices</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best Influencer Marketing Agency in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Authentic Matching</strong>
            We prioritize genuine audience fit over follower count alone.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've delivered influencer campaigns with strong reach and real ROI.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Full-Service Management</strong>
            We handle the entire process, from discovery to reporting.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds Influencer Marketing for Real Trust", 
      content: (
        <div className="space-y-4">
          <p>
            People trust people. That's the power behind influencer marketing. As a leading influencer marketing agency in Dubai, we build partnerships that feel authentic rather than forced.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build Influencer Campaigns That Meet Front-Line Technology</strong>
            Our mission is to help brands grow through genuine voices — from influencer discovery to full campaign execution, tracked for real performance.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our Influencer Marketing Services Are Built for Authentic Reach</strong>
            We work closely with clients to identify the right influencer partners, manage every stage of the campaign, and track results closely.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Influencer Marketing Features That Drive Results</strong>
            With authentic partnerships, careful vetting, and performance tracking, our campaigns help drive real reach, engagement, and ROI.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your Influencer Partnership Partner</h1>
            </div>
            ...
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We identify and partner with influencers whose audience genuinely aligns with your brand ,building campaigns that feel authentic and drive real engagement, trust, and conversions.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Influencer discovery and vetting</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Authentic, brand-aligned partnerships</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Full campaign management and reporting</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Influencer Marketing" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Influencer Marketing<br />Agency<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              ...
              <p className="text-red-100 text-[17px] font-light">
                Let's build an influencer strategy that engages your audience authentically.
              </p>
            </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              Influencer Strategies Built for<br className="hidden md:block" />
              Real Impact
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              At CoreUnity Solutions, we blend creative matchmaking, campaign management, 
              and data-driven tracking to build influencer campaigns that deliver measurable ROI.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Influencer Partnerships</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">70%</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Avg Trust Boost</p>
            </div>
            {/* Card 3 */}
            ...
            <div className="bg-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-xl">
              ...
              <p className="text-[#1f1f1f] text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Campaign Monitoring</p>
            </div>
          </div>
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Discovery & Vetting</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Identifying influencers whose audience genuinely matches your brand and conducting careful vetting.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Strategy & Briefing</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Developing authentic campaigns, setting clear goals, and briefing influencers on creative guidelines.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Campaign Execution</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Managing outreach, content approval, and ensuring smooth partnership rollouts from start to finish.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Tracking & Reporting</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Tracking reach, engagement, and conversions to measure the real ROI of your influencer partnerships.</p>
            </div>
          </div>
        </div>
      </section>
