...
export default function PPCPage() {
  ...
  const accordionItems = [
    { 
      title: "We Build PPC Campaigns That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Precision Targeting</strong>
            CoreUnity builds campaigns that reach the audiences most likely to convert.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Creative That Converts</strong>
            We design ad copy and creatives built to earn clicks and drive action.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Landing Page Optimization</strong>
            Our landing pages are built specifically to convert ad traffic.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of campaign strategy</li>
          <li>We give attention to the smallest performance details</li>
          <li>We help brands grow ROI, not just traffic</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best PPC Agency in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Full-Funnel Expertise</strong>
            We manage everything from targeting to landing pages to conversion tracking.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've reduced cost-per-lead and improved ROAS for clients across industries.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Ongoing Optimization</strong>
            We test and refine campaigns continuously to keep improving results.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds PPC Campaigns for Better ROI", 
      content: (
        <div className="space-y-4">
          <p>
            Ad spend without strategy is just an expense. As a leading PPC agency in Dubai, we build and manage campaigns with strong targeting and clear performance tracking.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build PPC Features That Meet Front-Line Technology</strong>
            Our mission is to help businesses turn ad spend into real growth — from Google Ads to Meta Ads, tracked and optimized continuously.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our PPC Services Are Built for Measurable ROI</strong>
            We work closely with clients to build the right targeting strategy, test creatives, and refine campaigns based on real performance data.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">PPC Features That Drive Results</strong>
            With precise targeting, optimized landing pages, and continuous testing, our PPC campaigns help drive more qualified leads at a lower cost.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your Paid Media Partner</h1>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.15] text-white mb-6 tracking-tight">
              PPC Campaigns Built to Convert, Not Just Click
            </h2>
            
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We build and manage PPC campaigns across Google Ads, Meta Ads, and more, combining precise targeting, compelling ad copy, and conversion-optimized landing pages to turn clicks into customers.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Precision audience targeting</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Conversion-focused ad creatives and landing pages</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Continuous testing and optimization</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Pay Per Click Advertising" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading PPC<br />Agency<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              ...
              <p className="text-red-100 text-[17px] font-light">
                Let's build a PPC strategy that drives real business growth.
              </p>
            </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              PPC Strategies Built for<br className="hidden md:block" />
              Real Impact
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              At CoreUnity Solutions, we blend data-driven targeting, conversion optimization, 
              and strategic bidding to build ad campaigns that deliver measurable ROI.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">300+</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Ad Campaigns Managed</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">60%</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Avg ROAS Boost</p>
            </div>
            {/* Card 3 */}
            ...
            <div className="bg-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-xl">
              ...
              <p className="text-[#1f1f1f] text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Monitoring & Optimization</p>
            </div>
          </div>
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Analyzing your target audience, competitors, and selecting the most effective ad platforms.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Campaign Setup & Targeting</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Building campaigns, setting up tracking, and defining precise audience targeting parameters.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Creative & Landing Pages</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Designing ad copy, visual assets, and high-converting landing pages to maximize ROI.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Optimization & Scaling</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Continuously testing ads, adjusting bids, and optimizing performance to lower cost-per-lead.</p>
            </div>
          </div>
        </div>
      </section>
