...
export default function AIDevelopmentPage() {
  ...
  const accordionItems = [
    { 
      title: "We Build AI Solutions That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Custom Model Development</strong>
            CoreUnity builds AI models tailored to your specific business challenges.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Business-First Approach</strong>
            We focus on AI that solves real problems, not just trend-chasing.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Seamless Integration</strong>
            Our AI solutions integrate cleanly into your existing systems and workflows.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of AI adoption</li>
          <li>We give attention to the details that make AI genuinely useful</li>
          <li>We help businesses grow through smarter automation</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best AI Development Company in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Practical AI Expertise</strong>
            We build AI that delivers measurable business value, not just novelty.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've delivered AI solutions across multiple industries and use cases.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Ongoing Support</strong>
            We stay by your side post-deployment, refining models as data grows.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Is a Full-Service AI Development Company Built for Real Results", 
      content: (
        <div className="space-y-4">
          <p>
            As a dedicated AI development company in Dubai, we help businesses go beyond the hype and implement AI that solves real problems.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build AI Features That Meet Front-Line Technology</strong>
            Our mission is to help businesses automate smarter and decide faster — from predictive analytics to custom machine learning models.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our AI Development Services Are Built for Long-Term Value</strong>
            We work closely with clients to identify where AI creates the most value, then design, build, and refine solutions around their systems and data.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">AI Development Features That Drive Results</strong>
            With custom models, seamless integration, and ongoing refinement, our AI solutions help businesses save time and make smarter decisions.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your AI Development Partner</h1>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.15] text-white mb-6 tracking-tight">
              A Full-Service AI Development Company Built for Real Results
            </h2>
            
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              As a dedicated AI development company in Dubai, we help businesses implement AI solutions that solve real problems, from intelligent automation to custom machine learning models built around your goals.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Custom AI models built around your data</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Business-first, practical AI applications</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Seamless integration into existing systems</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="AI Development Company" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading AI Development<br />Company<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight">
                Ready to adopt smarter automation?
              </h2>
              <p className="text-red-100 text-[17px] font-light">
                Let's build an AI solution that drives real efficiency for your business.
              </p>
            </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              AI Solutions Built for<br className="hidden md:block" />
              Real Impact
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              At CoreUnity Solutions, we blend business strategy, advanced machine learning, 
              and practical implementation to build AI applications that deliver measurable value.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">AI Solutions Deployed</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
            ...
            <div className="bg-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-xl">
              ...
              <p className="text-[#1f1f1f] text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Ongoing Model Refinement</p>
            </div>
          </div>
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Understanding your business goals, identifying AI use cases, and assessing your data readiness.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Architecture & Design</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Designing scalable AI architectures and selecting the right machine learning models for your needs.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Model Development</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Building, training, and fine-tuning custom AI models using your business data.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Deploying the solution seamlessly into your systems and providing ongoing support as data grows.</p>
            </div>
          </div>
        </div>
      </section>
