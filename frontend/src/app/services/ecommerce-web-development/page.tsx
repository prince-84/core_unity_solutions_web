...
export default function EcommerceWebDevelopmentPage() {
  const [activeAccordion, setActiveAccordion] = useState<number | null>(0);
  const accordionItems = [
    { 
      title: "We Develop Ecommerce Websites That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Responsive Design</strong>
            CoreUnity delivers fully responsive, expertly designed ecommerce websites optimized for various product catalogs and industries.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">SEO Adaptable</strong>
            We develop SEO-adaptable ecommerce websites that rank higher on search engines and attract the right shoppers.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">CMS Integration</strong>
            Our experts design ecommerce sites that house dynamic content, including products, blog posts, promotions, all in one place.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of building your store</li>
          <li>We give attention to even the smallest details of your brand</li>
          <li>We help ecommerce brands grow to the next level</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best Ecommerce Website Developers in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Diverse Platform Expertise</strong>
            Shopify, WooCommerce, Magento, or any other ecommerce platform, we build your online store on the right foundation.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've developed and launched countless ecommerce websites, on time and built to convert.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">24/7 Support</strong>
            Once your store launches, we remain by your side with ongoing support.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Transforms Ecommerce Websites for a Better Customer Journey", 
      content: (
        <div className="space-y-4">
          <p>
            Crafting a great ecommerce website is the first step once you decide to sell online. It's your chance to make a lasting impression on customers. As a top ecommerce website design company in Dubai, we offer high-end design with strong technical development built in.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Design Ecommerce Features That Meet Front-Line Technology</strong>
            Our mission is to help businesses create stunning, functional ecommerce websites that drive results. From custom design to full development, we ensure a seamless shopping experience, including payment gateways and shipping options built in from the start.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our Ecommerce Web Development Services Are Built for Online Success</strong>
            We work closely with clients to analyze their unique needs and build a custom ecommerce solution. Our services include responsive design, ongoing maintenance, and SEO strategies that improve visibility over time.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Ecommerce Features That Drive Results</strong>
            With effective product presentation, optimized checkout, and clear calls-to-action, our ecommerce websites help drive more traffic, more conversions, and more revenue.
          </div>
          <p className="font-medium italic mt-4 text-[#c52833]">
            Ready to launch an online store that sells? <Link href="/contact" className="underline hover:text-red-700">Get a free ecommerce consultation today.</Link>
          </p>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your E-Com Web Partner</h1>
            </div>
            ...
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We create stunning, high-converting ecommerce websites focused on user experience. From product design and functionality to secure checkout and ease of use, we build online stores designed to sell.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Branded design and easy navigation</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Personalization and global reach</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Advanced security features</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Ecommerce Web Development" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Ecommerce<br />Web Agency<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              ...
              <p className="text-red-100 text-[17px] font-light">
                Let's build an ecommerce platform that converts.
              </p>
            </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              Ecommerce Built<br className="hidden md:block" />
              for Maximum Growth
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              At CoreUnity Solutions, we blend robust development, secure payment integration, 
              and seamless user experiences to create stores that drive revenue.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Stores Launched</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">500K+</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Transactions Handled</p>
            </div>
            {/* Card 3 */}
            ...
            {/* Card 4 */}
            <div className="bg-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-xl">
              <h3 className="text-[#c52833] text-[32px] md:text-[38px] font-bold tracking-tight">3X</h3>
              <p className="text-[#1f1f1f] text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Avg Revenue Growth</p>
            </div>
          </div>
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">We analyze your products, target audience, and set clear goals for your online store.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">UX/UI Design</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Creating intuitive, high-converting shopping experiences focused on user journey and brand identity.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Building a scalable, secure store and integrating payment gateways, shipping, and CRM systems.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Rigorous QA testing across all devices to ensure a bug-free, seamless launch.</p>
            </div>
          </div>
        </div>
      </section>
