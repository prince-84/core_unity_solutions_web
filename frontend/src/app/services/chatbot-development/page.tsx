...
export default function ChatbotDevelopmentPage() {
  ...
  const accordionItems = [
    { 
      title: "We Build Chatbots That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Conversational AI Design</strong>
            CoreUnity builds chatbots trained around your business, tone, and customer journey.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Multi-Platform Integration</strong>
            We integrate chatbots into your website, app, and messaging platforms seamlessly.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Continuous Learning</strong>
            Our chatbots improve over time, learning from real customer interactions.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of chatbot deployment</li>
          <li>We give attention to the details that make conversations feel natural</li>
          <li>We help businesses grow through faster, smarter support</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best Chatbot Developers in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Brand-Aligned Conversation Design</strong>
            We build chatbots that actually sound like your brand.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've deployed chatbots that reduce support costs and boost engagement.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Ongoing Optimization</strong>
            We continue refining chatbot performance long after launch.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds Chatbots for Better Customer Support", 
      content: (
        <div className="space-y-4">
          <p>
            Customers expect instant answers, and a well-built chatbot delivers exactly that. As a leading chatbot development company in Dubai, we design conversational AI with strong technical performance and actual personality.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build Chatbot Features That Meet Front-Line Technology</strong>
            Our mission is to help businesses respond faster and support smarter — from FAQ automation to lead qualification, integrated cleanly into your existing channels.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our Chatbot Development Services Are Built for Better Engagement</strong>
            We work closely with clients to train chatbots around their tone and customer journey, keeping conversations running smoothly and improving responses through ongoing optimization.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Chatbot Features That Drive Results</strong>
            With instant responses, natural conversation flow, and smart escalation to human agents when needed, our chatbots help improve satisfaction and reduce support costs.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your Chatbot Development Partner</h1>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.15] text-white mb-6 tracking-tight">
              Chatbots That Actually Help Your Customers and Your Business
            </h2>
            
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We build AI-powered chatbots that deliver instant, on-brand support around the clock. From FAQs to lead qualification, our chatbots feel natural, helpful, and true to your brand voice.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> 24/7 automated customer support</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Natural, on-brand conversation design</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Seamless integration across platforms</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Chatbot Development" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Chatbot<br />Development Agency<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight">
                Ready to implement a chatbot?
              </h2>
              <p className="text-red-100 text-[17px] font-light">
                Let's build intelligent solutions that scale your business.
              </p>
            </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              Chatbots Built for<br className="hidden md:block" />
              Real Impact
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              At CoreUnity Solutions, we blend data science, robust architecture, 
              and business strategy to build chatbots that deliver measurable ROI.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">AI Models Deployed</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">40%</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Avg Efficiency Boost</p>
            </div>
            {/* Card 3 */}
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Analyzing your data, processes, and identifying high-impact AI use cases for your business.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">AI Model Design</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Selecting algorithms and structuring pipelines for predictive analysis, NLP, or automation.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Training models and seamlessly connecting AI capabilities into your existing software stack.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Launching solutions, monitoring performance, and refining models as new data flows in.</p>
            </div>
          </div>
        </div>
      </section>
