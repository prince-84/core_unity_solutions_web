...
export default function SocialMediaMarketingPage() {
  ...
  const accordionItems = [
    { 
      title: "We Build Social Strategies That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Content Creation</strong>
            CoreUnity produces scroll-stopping content tailored to each platform.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Community Management</strong>
            We actively engage with your audience, building genuine connections.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Paid Social Campaigns</strong>
            Our targeted ad campaigns extend your reach and drive conversions.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of your social strategy</li>
          <li>We give attention to the smallest engagement details</li>
          <li>We help brands build real communities, not just followers</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best Social Media Agency in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Platform Expertise</strong>
            We understand what works differently across Facebook, Instagram, X, and LinkedIn.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've grown engagement and followings for brands across industries.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Ongoing Optimization</strong>
            We track performance weekly to double down on what resonates.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds Social Media Strategies for Real Community Growth", 
      content: (
        <div className="space-y-4">
          <p>
            Growing on social media takes more than consistent posting. It takes strategy and genuine engagement. As a leading social media marketing agency in Dubai, we manage content and campaigns across every major platform.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build Social Media Features That Meet Front-Line Technology</strong>
            Our mission is to help brands build real connections online — from content creation to community management, tailored to your audience.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our Social Media Marketing Services Are Built for Engagement</strong>
            We work closely with clients to build platform-specific strategies, manage community interactions, and track performance to keep engagement climbing.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Social Media Features That Drive Results</strong>
            With scroll-stopping content, active engagement, and targeted ad campaigns, our social strategies help turn followers into loyal customers
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your Social Growth Partner</h1>
            </div>
            ...
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We manage content creation, community engagement, and paid campaigns across Facebook, Instagram, X, and LinkedIn, building strategies that turn followers into loyal customers.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Platform-specific content strategy</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Active community management</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Paid social campaigns built for ROI</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Social Media Marketing" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Social Media<br />Agency<br />in Dubai
            </h2>
          </div>
