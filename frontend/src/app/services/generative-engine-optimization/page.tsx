...
export default function GEOPage() {
  ...
  const accordionItems = [
    { 
      title: "We Build GEO Strategies That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Structured Content Design</strong>
            CoreUnity formats content in ways AI search engines can easily read and cite.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Authority Building</strong>
            We strengthen your brand's credibility signals across the web.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Continuous Monitoring</strong>
            We track how your brand appears across AI-driven search platforms.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of GEO strategy</li>
          <li>We give attention to the smallest content structuring details</li>
          <li>We help brands stay visible as search evolves</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best GEO Agency in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Early-Mover Expertise</strong>
            We stay ahead of how AI search engines evaluate and surface content.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven SEO Foundation</strong>
            Our GEO strategies build on strong, proven SEO fundamentals.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Ongoing Adaptation</strong>
            We continuously adjust strategy as AI search platforms evolve.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds GEO for the New Era of Search", 
      content: (
        <div className="space-y-4">
          <p>
            As AI-powered search reshapes how people find information, ranking on traditional results isn't enough. As a leading GEO agency in Dubai, we help brands stay visible across AI-generated answers and summaries.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build GEO Features That Meet Front-Line Technology</strong>
            Our mission is to help businesses stay ahead of search evolution — from structured content to authoritative sourcing, built for AI-driven platforms.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our GEO Services Are Built for Future Visibility</strong>
            We work closely with clients to structure content for AI readability, strengthen authority signals, and monitor performance across generative search platforms.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">GEO Features That Drive Results</strong>
            With structured content, strong sourcing, and continuous monitoring, our GEO strategies help keep your brand visible as search behavior changes.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your AI Search Visibility Partner</h1>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.15] text-white mb-6 tracking-tight">
              Generative Engine Optimization for the New Era of Search
            </h2>
            
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We optimize your brand's content and digital presence to appear in AI-generated answers, summaries, and recommendations, keeping you visible as search evolves beyond traditional results pages.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Structured, AI-readable content</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Authoritative sourcing and citations</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Visibility across AI search and answer engines</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Generative Engine Optimization" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading GEO<br />Agency<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              ...
              <p className="text-red-100 text-[17px] font-light">
                Let's build a GEO strategy that prepares you for the new era of search.
              </p>
            </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              GEO Strategies Built for<br className="hidden md:block" />
              Real Impact
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              ...
              and AI insights to build GEO campaigns that keep your brand visible.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">AI Answers Optimized</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              <h3 className="text-white text-[32px] md:text-[38px] font-bold tracking-tight">60%</h3>
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Avg Visibility Boost</p>
            </div>
            {/* Card 3 */}
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Analyzing your content strategy and identifying how your brand appears in AI search engines.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Structured Content Design</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Formatting and structuring your content so AI platforms can easily read, parse, and cite your insights.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Authority Building</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Strengthening your brand's credibility and external signals to become a trusted source for AI generation.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Monitoring & Adaptation</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Continuously tracking your brand's presence in AI-generated answers and refining the strategy.</p>
            </div>
          </div>
        </div>
      </section>
