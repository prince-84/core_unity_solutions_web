...
export default function DigitalMarketingPage() {
  ...
  const accordionItems = [
    { 
      title: "We Build Marketing Strategies That Stand Out", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Multi-Channel Strategy</strong>
            CoreUnity connects SEO, PPC, and social media into one cohesive growth strategy.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Data-Driven Decisions</strong>
            We track performance closely, adjusting strategy based on real results.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Full Transparency</strong>
            Our clients always know what's working, what's not, and why.
          </div>
        </div>
      ) 
    },
    { 
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>We guide you through every step of your marketing strategy</li>
          <li>We give attention to the smallest performance details</li>
          <li>We help brands grow to the next level</li>
          <li>Our track record speaks for itself</li>
        </ul>
      ) 
    },
    { 
      title: "What Makes Us the Best Digital Marketing Agency in Dubai?", 
      content: (
        <div className="space-y-4">
          <div>
            <strong className="text-gray-800 block mb-1">Full-Service Expertise</strong>
            One team handles every channel, so your strategy stays connected.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Proven Track Record</strong>
            We've delivered measurable growth for clients across industries.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Ongoing Optimization</strong>
            We continuously refine campaigns to keep improving performance.
          </div>
        </div>
      ) 
    },
    { 
      title: "CoreUnity Solutions Builds Digital Marketing for Better Business Growth", 
      content: (
        <div className="space-y-4">
          <p>
            Growing a brand online takes more than scattered efforts. It takes a connected strategy. As a full-service digital marketing agency in Dubai, we bring every channel together under one roof.
          </p>
          <div>
            <strong className="text-gray-800 block mb-1">We Build Marketing Strategies That Meet Front-Line Technology</strong>
            Our mission is to help businesses grow through data-driven strategy — from SEO to paid media, built around your audience and your goals.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Our Digital Marketing Services Are Built for Real ROI</strong>
            We work closely with clients to understand their business, build the right channel mix, and track performance monthly to keep improving results.
          </div>
          <div>
            <strong className="text-gray-800 block mb-1">Marketing Features That Drive Results</strong>
            With targeted campaigns, SEO-ready content, and continuous optimization, our strategies help drive more traffic, more leads, and more revenue.
          </div>
        </div>
      ) 
    },
        ...
        <div className="max-w-[1300px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 mt-10">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-xl md:text-[22px] font-bold tracking-wide text-white uppercase">Your Digital Growth Partner</h1>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-bold leading-[1.15] text-white mb-6 tracking-tight">
              Digital Marketing Strategies Built to Grow Your Business
            </h2>
            
            <p className="text-[#cccccc] text-lg leading-relaxed font-light mb-4">
              We build connected digital marketing strategies across SEO, PPC, social media, and content — all working toward one goal: real, measurable growth for your business.
            </p>
            <ul className="text-[#cccccc] text-lg font-light space-y-2 list-none pl-0">
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Data-driven strategy across every channel</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Transparent reporting and performance tracking</li>
              <li className="flex items-center gap-2"><span className="text-[#c52833]">✓</span> Campaigns built around your specific goals</li>
            </ul>
          </div>

          {/* Right Content: Form */}
          <div className="flex justify-center lg:justify-end w-full">
            <ServiceInquiryForm pageName="Digital Marketing" />
          </div>
        ...
        <div className="max-w-[1300px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 mb-24">
          ...
          <div className="flex flex-col pt-4">
            <h2 className="text-[32px] md:text-[40px] font-semibold text-[#1f1f1f] leading-[1.2] tracking-tight">
              Leading Digital Marketing<br />Agency<br />in Dubai
            </h2>
          </div>
          ...
          <div className="max-w-[1300px] mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-8 transition-transform duration-300 group-hover:scale-[1.01]">
            <div className="flex flex-col">
              ...
              <p className="text-red-100 text-[17px] font-light">
                Let's build a strategy that drives real business growth.
              </p>
            </div>
        ...
        <div className="max-w-[1300px] w-full mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="flex-1 text-white pr-0 md:pr-4">
            <h2 className="text-[36px] md:text-[44px] leading-[1.1] font-bold mb-6 tracking-tight">
              Digital Marketing Strategies Built for<br className="hidden md:block" />
              Real Impact
            </h2>
            <p className="text-[16px] md:text-[17px] text-gray-300 font-light leading-relaxed max-w-[480px]">
              ...
              and business strategy to build campaigns that deliver measurable ROI.
            </p>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-[500px]">
            ...
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              ...
              <p className="text-gray-300 text-[11px] md:text-[12px] font-bold tracking-widest uppercase">Marketing Campaigns Delivered</p>
            </div>
            {/* Card 2 */}
            <div className="bg-[#1a1a1a] border border-white rounded-[14px] py-9 px-4 md:px-6 flex flex-col items-center justify-center text-center gap-1 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
        ...
        <div className="max-w-[1300px] mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              ...
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Analyzing your audience, competitors, and identifying high-impact marketing channels for your brand.</p>
            </div>
            {/* Process 2 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Strategy Design</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Crafting targeted campaigns, SEO-ready content, and cohesive channel mixes.</p>
            </div>
            {/* Process 3 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Execution & Launch</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Building campaigns, producing assets, and launching strategies across digital platforms.</p>
            </div>
            {/* Process 4 */}
            <div className="flex flex-col bg-[#f8f9fa] hover:bg-[#c52833] transition-colors duration-300 rounded-[20px] p-8 border border-gray-100 hover:border-transparent group">
              <div className="w-12 h-12 bg-[#3f3f46] rounded-[14px] flex items-center justify-center mb-8">
              ...
              <h4 className="text-[22px] font-bold text-[#1f1f1f] group-hover:text-white transition-colors duration-300 mb-3">Optimization & Reporting</h4>
              <p className="text-gray-500 group-hover:text-white/90 transition-colors duration-300 text-[15px] leading-relaxed">Monitoring performance, refining ad spend, and adjusting strategy based on data insights.</p>
            </div>
          </div>
        </div>
      </section>
