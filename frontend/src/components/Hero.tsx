  ...
  return (
    <div className="flex flex-col items-center justify-center text-center mt-12 max-w-5xl mx-auto px-4 z-20 relative">
      ...
      <div className="relative flex items-center justify-center w-full max-w-sm mx-auto">
        ...
        {/* Button */}
        <button className="relative z-10 bg-red-600 hover:bg-red-700 text-white pl-5 pr-2 py-2 rounded-full font-medium text-sm flex items-center gap-3 transition-colors shadow-[0_0_20px_rgba(220,38,38,0.4)]">
          Schedule a call
