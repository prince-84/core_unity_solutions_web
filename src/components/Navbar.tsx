  ...
  return (
    <nav className="fixed top-0 left-0 w-full flex items-center justify-between px-8 py-4 z-50 bg-transparent">
      ...
      <div className="hidden md:flex items-center gap-6 text-sm font-medium">
        <Link href="/" className="bg-red-600 text-white px-4 py-1.5 rounded-lg">
          Home
        </Link>
      ...
      <div className="flex items-center gap-3">
        <button className="bg-red-600 hover:bg-red-700 text-white text-sm font-medium px-5 py-2 rounded-lg transition-colors hidden sm:block">
          Speak to an expert
        </button>
        ...
        <button className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-300 hover:text-white hover:border-gray-500 transition-colors">
